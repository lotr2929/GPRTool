    ...
    function loadMapTiles(bbox) {
      ...
      // Hide grid when map tiles are active — tiles provide spatial reference
    ...
    function clearMapTiles() {
      ...
      mapTileGroup = null;
      // Restore grid when map is cleared
      setGridVisible(currentMode === '2d');
    }
